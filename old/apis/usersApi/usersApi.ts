...
const findSettings = async (funcName: string) => {
 ...
 */
export const authenticatedUserBirthdate = async (): Promise<
...
> => {
  return BaseHandler(async () => {
    ...
    const { data:rawData, res } = await this.http.get<AuthenticatedUserBirthdateData>("/v1/birthdate", {
      cacheSettings: config.apiCacheMiddleware && await this.findSettings(this.getCallerFunctionName())
    })
 ...
 */
export const authenticatedUserDescription = async (): Promise<
 ...
 */
export const authenticatedUserGender = async (): Promise<
 ...
 * @exampleRawData {}
 */
export const validateDisplayNameForNewUser = async (displayName:string, birthdate: string): Promise<
 ...
 * @exampleRawData {}
 */
export const validateDisplayNameForExistingUser = async (displayName:string, userId: number): Promise<
 ...
 * @exampleRawData {}
 */
export const setDisplayNameForAuthenticatedUser = async (newDisplayName:string, userId: number): Promise<
 ...
 */
export const userInfo = async (userId: number): Promise<
 ...
 */
export const authenticatedUserInfo = async (): Promise<
 ...
 */
export const authenticatedUserAgeBracket = async (): Promise<
 ...
 */
export const authenticatedUserCountryCode = async (): Promise<
 ...
 */
export const authenticatedUserRoles = async (): Promise<
 ...
 */
export const usernamesToUsersInfo = async <Username extends string>(
 ...
 */
export const userIdsToUsersInfo = async <UserId extends number>(
 ...
 */
export const usernameHistory = async (userId: number, limit:10|25|50|100=100, sortOrder:SortOrder="Asc", cursor?: string): Promise<
 ...
 */
export const search = async (keyword:string, limit:10|25|50|100=100, cursor?:string): Promise<
