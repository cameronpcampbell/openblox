...
import { GroupsApiClass } from "../apis/groupsApi"
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
export class OpenbloxClient {
  apis: { [Key in keyof typeof AllApis]: ApiMethods<typeof AllApis[Key]> }
  ...
  constructor({ cookie, apiCacheMiddleware, csrfRetries = 1}: ClientConfig) {
    this.apis = {
      ...
      GroupsApi: new GroupsApiClass({cookie, apiCacheMiddleware, csrfRetries})
    }
  }
}