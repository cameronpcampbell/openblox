...
// [ Variables ] /////////////////////////////////////////////////////////////////
const addApiMethod = createApiGroup({ name: "LegacyFollowings", baseUrl: "https://apis.roblox.com/legacy-followings" })
//////////////////////////////////////////////////////////////////////////////////
 ...
 */
export const universeFollowingsForUser = addApiMethod(async <UserId extends Identifier>(
 ...
 */
export const universeFollowingStatusForUser = addApiMethod(async <UniverseId extends Identifier, UserId extends Identifier>(
 ...
 * @exampleRawBody {"universeId":4922741943,"userId":45348281} {"universeId":4922741943,"userId":45348281}
 */
export const authedUserFollowUniverse = addApiMethod(async <UniverseId extends Identifier, UserId extends Identifier>(
  { universeId, userId }: { universeId: UniverseId, userId: UserId }
): ApiMethod<{ universeId: UniverseId, userId: UserId }> => ({
  method: "POST",
  path: `/v1/users/${userId}/universes/${universeId}`,
