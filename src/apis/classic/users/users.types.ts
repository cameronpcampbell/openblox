...
// [ Account Information ] ///////////////////////////////////////////////////////
// GET /v1/birthdate
export type RawAuthenticatedUserBirthdateData = ObjectPrettify<{
  birthMonth: number,
  birthDay: number,
  birthYear: number
}>
...
// GET /v1/description
export type RawAuthenticatedUserDescriptionData = ObjectPrettify<{ description: string }
>
// GET /v1/gender
export type RawAuthenticatedUserGenderData = ObjectPrettify<{ gender: 1 | 2 | 3 }>
...
// [ Users ] /////////////////////////////////////////////////////////////////////
// GET /v1/users/{userId}
type UserInfoData<UserId extends Identifier, TimeType> = ObjectPrettify<{
  description: string,
  created: TimeType,
  isBanned: boolean,
...
export type AuthenticatedUserInfoData = ObjectPrettify<{
  id: number,
  name: string,
  displayName: string
}>
...
export type RawAuthenticatedUserAgeBracketData = ObjectPrettify<{ ageBracket: 0 | 1 }>
export type PrettifiedAuthenticatedUserAgeBracketData = UnionPrettify<"13+" | "<13">

// GET /v1/users/authenticated/country-code
export type RawAuthenticatedUserCountryCodeData = ObjectPrettify<{ countryCode: PrettifiedAuthenticatedUserCountryCodeData }>
...
export type RawAuthenticatedUserRolesData = ObjectPrettify<{ roles: string[] }>

// POST /v1/usernames/users
export type RawUsernamesToUsersInfoData<Username extends string> = ObjectPrettify<{
  data: { 
...
export type PrettifiedUsernamesToUsersInfoData<Username extends string> = ObjectPrettify<Partial<Record<Username, {
  hasVerifiedBadge: boolean,
  id: number,
  name: string,
  displayName: string
