 ...
 */
export const assetResaleData = addApiMethod(async (
 ...
 */
export const assetResellers = addApiMethod(async (
 ...
 */
export const authedUserAssetResellableCopies = addApiMethod(async (
 ...
 */
export const assetResaleTaxRate = addApiMethod(async (
 ...
 */
export const authedUserDevExCashOutInfo = addApiMethod(async (
 ...
 */
export const groupCanAddFunds = addApiMethod(async (
 ...
 */
export const groupLatestAddedFundsData = addApiMethod(async (
  { groupId }: { groupId: Identifier }
 ...
 */
export const groupCurrency = addApiMethod(async (
  { groupId }: { groupId: Identifier }
 ...
 * @exampleRawBody {"robux":0}
 */
export const authedUserCurrency = addApiMethod(async (
): ApiMethod<{ robux: number }> => ({
  method: "GET",
 ...
 */
export const groupRevenueSummary = addApiMethod(async (
 ...
 */
export const groupTransactionHistory = addApiMethod(async <Type extends GroupTransactionType>(
 ...
 */
export const authedUserEconomyMetadata = addApiMethod(async (
