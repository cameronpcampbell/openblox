 ...
 */
export const universesProductInfo = addApiMethod(async <UniverseId extends Identifier>(
  { universeIds }: { universeIds: ArrayNonEmptyIfConst<UniverseId> }
 ...
 */
export const authedUserSpotlightedGames = addApiMethod(async (
 ...
 */
export const placesInfo = addApiMethod(async <PlaceId extends Identifier>(
 ...
 */
export const authedUserGamesPlayabilityStatuses = addApiMethod(async <UniverseId extends Identifier>(
  { universeIds }: { universeIds: ArrayNonEmptyIfConst<UniverseId> }
 ...
 */
export const recommendationsFromUniverse = addApiMethod(async (
 ...
 */
export const authedUserPrivateServersForPlace = addApiMethod(async (
 ...
 */
export const placeServerList = addApiMethod(async (
 ...
 */
export const authedUserUniverseIsFavorited = addApiMethod(async (
 ...
 * @exampleRawBody {}
 */
export const authedUserUniverseSetFavorite = addApiMethod(async (
 ...
 */
export const universeFavoritesCount = addApiMethod(async (
  { universeId }: { universeId: Identifier }
 ...
 */
export const universeGamePasses = addApiMethod(async (
 ...
 */
export const authedUserUniverseVoteStatus = addApiMethod(async (
  { universeId }: { universeId: Identifier }
 ...
 */
export const universesVoteStatus = addApiMethod(async <UniverseId extends Identifier>(
  { universeIds }: { universeIds: ArrayNonEmptyIfConst<UniverseId> }
 ...
 * @exampleRawBody {}
 */
export const authedUserSetUniverseUpvote = addApiMethod(async (
 ...
 */
export const vipServersAllowedForUniverse = addApiMethod(async (
  { universeId }: { universeId: Identifier }
 ...
 */
export const authedUserCanUserBeInvitedToVipServer = addApiMethod(async (
 ...
 */
export const vipServerInfo = addApiMethod(async <VipServerId extends Identifier>(
 ...
 * 
 * @example const { data:serverInfo } = await ClassicGamesApi.updateVipServer({ vipServerId: , name: "New Name" })
 ...
 * @exampleRawBody {"id":1630945839,"name":"New Name","game":{"id":6430220996,"name":"Get Id","rootPlace":{"id":18980972074,"name":"Get Id"}},"joinCode":"70420354791950165689950670608627","active":true,"subscription":{"active":false,"expired":false,"expirationDate":"2024-09-17T15:49:02.8879762Z","price":null,"canRenew":false,"hasInsufficientFunds":false,"hasRecurringProfile":true,"hasPriceChanged":true},"permissions":{"clanAllowed":false,"enemyClanId":null,"friendsAllowed":false,"users":[]},"voiceSettings":{"enabled":false},"link":"https://www.roblox.com/games/18980972074?privateServerLinkCode=70420354791950165689950670608627"} 
 */
export const updateVipServer = addApiMethod(async <
 ...
 */
export const updateVipServerVoiceSettings = addApiMethod(async <Enabled extends boolean>(
 ...
 */
export const universeMedia = addApiMethod(async (
  { universeId }: { universeId: Identifier }
 ...
 */
export const groupGames = addApiMethod(async <GroupId extends Identifier>(
